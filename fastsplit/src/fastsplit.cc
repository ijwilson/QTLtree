...
int main(int argc, char *argv[]) 
{
  ...
  std::string infile,traitFile,positionFile,regionFile,excludeFile,QTLfile,stem,direction,PickStat;
  double FirstPos,LastPos,maxdistance;
  bool regional=false,removeCentre=false,loud=true;

  const char *version=SVN_REV;          /// get the version number from SVN
